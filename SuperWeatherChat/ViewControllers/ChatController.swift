...
//  EarlyWarningSystem
//
//  Created by Eric Cha on 12/27/18.
...
class ChatController: SamuraiViewController, UITextViewDelegate {
    ...
    func setUpImgView() {
        ...
        friendImg.layer.borderColor = #colorLiteral(red: 1, green: 0.6112429371, blue: 0.6917650963, alpha: 0.5)
